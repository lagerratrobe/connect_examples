...
### 1. Create a new Shiny Web App

![](shiny/images/1_shiny_app_create.png){fig-align="left" width=100%}

We named ours, "Shiny_Example"

![](shiny/images/2_shiny_app_name.png){fig-align="left" width=50%}
...
![](shiny/images/7_publish_app.png){fig-align="left" width=50%}
...
![](shiny/images/9_deploy_details.png){fig-align="left" width=80%}
...
![](shiny/images/8_verify_connect.png){fig-align="left" width=100%}
