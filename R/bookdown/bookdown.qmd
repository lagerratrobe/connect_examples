...
![](bookdown/images/1_bookdown_proj.png){fig-align="left" width=100%}

We named ours, "Bookdown_Example"

![](bookdown/images/2_bookdown_example.png){fig-align="left" width=50%}
...
![](bookdown/images/4_bookdown_preview_select.png){fig-align="left" width=80%}

### 3. Preview the site locally

Press the "Knit" button and you should see "A Minimal Book Example" displayed in the Viewer Pane on the lower right.

![](bookdown/images/3_bookdown_index_knit.png){fig-align="left" width=100%}
...
![](bookdown/images/6_bookdown_publish_with_source.png){fig-align="left" width=100%}

Select all of the files and the server that you want to to publish to and then press __Publish__.

![](bookdown/images/7_bookdown_publish_files_server.png){fig-align="left" width=50%}
...
Site successfully deployed to http://3.144.138.21/content/6ed04778-cdb0-4a67-aaf1-2ed8ed814617/
Deployment completed: http://3.144.138.21/connect/#/apps/6ed04778-cdb0-4a67-aaf1-2ed8ed814617
```
...
![](bookdown/images/8_bookdown_verify_on_connect.png){fig-align="left" width=100%}