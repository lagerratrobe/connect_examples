...
This guide is intended for System Administrators and IT professionals who are responsible for installing and configuring Connect at their organizations.  It is not intended as a Data Science primer, or as a reference for R and Python programming.  Knowledgeable users of those languages will not find new idiomatic code constructs or tricks for parallelizing data processing workflows here.  However, anyone who wants to better understand how to publish a specific type of content to a Connect server, and to verify that the content functions, will likely benefit from reading this guide.
